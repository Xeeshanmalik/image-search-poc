...
export IMAGES_PER_CATEGORY=100
export BATCH_SIZE=2
export EPOCHS=30
...
export DATA='testingset_raw/cars_test'
...
export TEST_PATH='./testingset_obj_extracted'
export SEGMENTED_OUTPUT_PATH='./testingset_tmp/'
export SCORE_THRESHOLD=0.3
export IOU=0.5
export FONT='./font/FiraMono-Medium.otf'
export JSON_OUTPUT='bounding_boxes_test.json'
export NUMBER_OF_PREDICTIONS=50
export PRECISION_COUNTER='3,5,10,50' # The Last value should be similar to ${NUMBER_OF_PREDICTIONS}


export SUPERSET_FILTER=10
export NUMBER_OF_CLASS_PER_FILTER=2
export COUNT_PER_FILTER=100000
export FILTER_TYPE='model'
export FILE_NAME='cars.json'
export OUTPUT_FILE_NAME='cars-filter-testing.json'
...
python model_predict_output.py \
${IMAGE_HEIGHT} \
${IMAGE_WIDTH} \
${CHANNEL} \
${T_IMAGE_HEIGHT} \
